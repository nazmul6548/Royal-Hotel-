          ...
          <div className="lg:p-10 p-6 font-[sans-serif] text-[#333] bg-gray-100">
            ...
            <div  className="grid md:grid-cols-3 md:gap-6 max-md:gap-10 max-w-6xl mx-auto">
                <div data-aos="flip-up" className="max-w-[350px] h-auto py-8 px-4 lg:px-8 rounded-md mx-auto bg-white relative">
                    ...
                    <div className="mt-4">
                        <p className="text-sm leading-relaxed">The accommodation at <span className="text-secondary">RoyalHotel</span> was nothing short of luxurious. The room was elegantly furnished, offering a perfect blend of comfort and sophistication. The plush bedding ensured a restful night's sleep, and the spacious layout provided ample space to relax and unwind.</p>
                        <h4 className="text-base whitespace-nowrap font-extrabold mt-4">Nazmul</h4>
                ...
                <div data-aos="flip-right"  className="max-w-[350px] h-auto py-8 px-4 lg:px-8 rounded-md mx-auto bg-white relative">
                    ...
                    <div className="mt-4">
                        <p className="text-sm leading-relaxed">The hospitality at <span className="text-secondary">RoyalHotel</span> was unparalleled. The staff members were welcoming, attentive, and went above and beyond to ensure that my stay was memorable.</p>
                        <h4 className="text-base whitespace-nowrap font-extrabold mt-4">Miftahul</h4>
                ...
                <div data-aos="flip-left" className="max-w-[350px] h-auto py-8 px-4 lg:px-8 rounded-md mx-auto bg-white relative">
                    ...
                    <div className="mt-4">
                        <p className="text-sm leading-relaxed"><span className="text-secondary">RoyalHotel</span> boasts an impressive array of amenities and facilities designed to enhance the guest experience. From the state-of-the-art fitness center to the tranquil spa, there was no shortage of ways to relax and rejuvenate.</p>
                        <h4 className="text-base whitespace-nowrap font-extrabold mt-4">Maria</h4>
